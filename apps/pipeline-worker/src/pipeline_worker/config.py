...
def load() -> tuple[ConnectionParameters, str, str, str, str, str]:
    ...
    return connection_params, gemini_api_key, gemini_model, telegram_bot_token, s3_bucket, deploy_hook_url
